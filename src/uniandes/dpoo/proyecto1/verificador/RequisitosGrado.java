...
public class RequisitosGrado
{
	...
	public static Map<String, Boolean> verificarRequisitosGradoEstudiante(Estudiante estudiante)
	{
		...
		Map<String, Integer> creditosSemestre = CalculadoraReportes.calcularCreditosPorSemestre(estudiante);
		int total_creditos = 0;
		for(Map.Entry<String, Integer> entry : creditosSemestre.entrySet())
		{
