...
public class ConsolaSistema
{
  ...
  {
	  System.out.println("sistema para la administraci髇 y seguimiento del p閚sum de\r\n"
	  		+ "un estudiante.\n");
		...
		while (continuar)
		{
			try
			{
				...
				{
					System.out.println("Para poder ejecutar esta opci贸n primero debe cargar un archivo de pensum.");
				}
				else
				{
					System.out.println("Por favor seleccione una opci髇 valida.");
				}
			}
       ...
       public void mostrarMenu()
	{
		...
		System.out.println("8. Salir de la aplicaci贸n\n");
	}
