...
public class AvanceDeCarrera extends JFrame implements ActionListener
{
	...
	private static final long serialVersionUID = 7L;
		...
		public AvanceDeCarrera()
		{
				...
				vacio1 = new JTextField("dalgo",5);
				vacio2 = new JTextField("mel",5);
				vacio3= new JTextField("tesis",5);
				vacio4 = new JTextField("integral",5);
				vacio5 = new JTextField("vectorial",5);
				vacio6 = new JTextField("diferencial",5);
				vacio7= new JTextField("infracomp",5);
				vacio8= new JTextField("cbu tipo colombia",5);
				vacio9 = new JTextField(5);
				vacio10 = new JTextField("fisica 1",5);
				vacio11= new JTextField(5);
				vacio12= new JTextField("fisica 2",5);
				vacio13= new JTextField(5);
				vacio14= new JTextField("EDA",5);
		 ...
		 public static void main(String[] args)
			{
		      ...
		      AvanceDeCarrera ventana = new  AvanceDeCarrera();
