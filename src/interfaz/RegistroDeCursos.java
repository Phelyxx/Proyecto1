...
public class RegistroDeCursos  extends JFrame implements ActionListener
{
	...
	public RegistroDeCursos(Estudiante estudiante)
	{
		...
		txtQueCodigoSemestre = new JTextField ("Código del semestre (Ejemplo: 2020-1): ");
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(fuente == inputcodeSemestre)
		{
			...
			{				
				{	
					if(codigosCartelera.contains(codigo))
					{
						...
						JOptionPane.showMessageDialog(rootPane, "Código de semestre digitado");
					}
					else
					{
			...
			{
				JOptionPane.showMessageDialog( this, "No existe una cartelera de semestre asociada a ese código de semestre", "Error", JOptionPane.ERROR_MESSAGE );
			}
		}
